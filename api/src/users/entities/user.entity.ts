import { Entity, Property, PrimaryKey, Unique, Collection, ManyToOne, OneToMany } from 'mikro-orm';
import { IsIn, IsEmail, IsMobilePhone, IsLocale, IsUUID } from 'class-validator';
